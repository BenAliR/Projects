                                                    ...
                                                    <table style="border-color: #efefef; border-style: solid; border-width: 1px; border-radius: 3px; border-collapse: separate; background-color: #ffffff;" width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p20t es-p15b" align="center">
                                                                <h3 style="color: #333333;">Les informations de votre compte:</h3>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-text" align="center">
                                                                <p style="color: #64434a; font-size: 16px; line-height: 150%;">email :{!! $data['email'] !!}</p>
                                                                <p style="color: #64434a; font-size: 16px; line-height: 150%;">Mot de passe: {!! $data['password'] !!}</p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-button es-p20t es-p20b es-p10r es-p10l" align="center"><span class="es-button-border" style="background: #f8f3ef none repeat scroll 0% 0%;"><a  href="{{ url('/') }}/login" class="es-button" target="_blank" style="background: #f8f3ef none repeat scroll 0% 0%; border-color: #f8f3ef;">S'identifier
</a></span></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
